		...
		return (
			<div className={classes.root}>
				...
				<Paper className={classes.content}>
					...
					<ul>
						<li>ログインするためにアカウント連携を行います。</li>
						<li>SNSのID、アカウント名、画像URLを保存しています。</li>
						<li>メールアドレスは収集していません。</li>
						<li>第三者にデータ提供を行うことはありません。</li>
					</ul>
				</Paper>
				<Paper className={classes.content}>
					<Typography variant="body2">
					<pre className={classes.pre}>
{`合同会社ときしらず（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）におけるプライバシー情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
...
export default withStyles(styleSheet)(Policy);
